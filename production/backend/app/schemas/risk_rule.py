...
class RiskRuleSet(_RiskRuleBase):
    ...
    version: int = Field(default=1, ge=1)
    effective_from_iso: Optional[IsoTimestamp] = None
    effective_to_iso: Optional[IsoTimestamp] = None
...
class RiskEvaluationResult(_RiskRuleBase):
    ...
    eval_id: Id
    enterprise_id: Optional[Id] = None
...
class RiskStreamEvent(_RiskRuleBase):
    ...
    risk_result_id: Optional[Id] = None
